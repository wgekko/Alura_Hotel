...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int ReservaId) {
		...
		txtNacionalidad.setModel(new DefaultComboBoxModel(new String[] { "afgano", "alemán",
				"árabe", "argentino", "austriaco","australiano", "belga", "boliviano",
				"brasileño", "camboyano", "canadiense", "chileno", "chino",
				"colombiano", "coreano", "costarricense", "cubano",
				"danés", "dominicano","ecuatoriano", "egipcio", "salvadoreño",
				"escocés", "español", "estadounidense", "estonio",
				"etiope", "filipino", "finlandés", "francés", "galés",
				"griego", "guatemalteco", "haitiano", "holandés",
				"hondureño", "indu","indonés", "inglés", "iraquí", "iraní",
				"irlandés", "israelí", "italiano", "japonés", "jordano",
				"laosiano", "letón", "letonés","libanes", "malayo", "marroquí",
				"mexicano","montenegrino", "nicaragüense", "noruego", "neozelandés",
				"neerdlandes","panameño", "paraguayo", "peruano", "polaco", "portugués",
				"puertorriqueño", "ruandes", "rumano", "ruso", "sirio","sudafricano","sueco",
				"suizo", "servio","tailandés", "taiwanes", "turco", "ucraniano",
				"uruguayo", "venezolano", "vietnamita" }));

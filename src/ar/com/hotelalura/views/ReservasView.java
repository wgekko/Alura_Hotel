...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		JLabel lblCheckIn = new JLabel("FECHA DE CHECK IN (ingreso)");
		lblCheckIn.setForeground(SystemColor.textInactiveText);
		lblCheckIn.setBounds(68, 136, 169, 14);
		lblCheckIn.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		panel.add(lblCheckIn);

		JLabel lblCheckOut = new JLabel("FECHA DE CHECK OUT (egreso)");
		...
		JLabel lblValor = new JLabel("IMPORTE DE LA RESERVA");
		...
		txtFormaPago.setModel(new DefaultComboBoxModel(
				new String[] { "Tarjeta de Crédito", "Tarjeta de Débito", "Dinero en efectivo","Mercado Pago" }));
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaE.getDate() != null && ReservasView.txtFechaS.getDate() != null) {
					...
					JOptionPane.showMessageDialog(null, "No deben haber campos sin completar.");
				}
			}
	...
	private void calcularEstadia (JDateChooser txtFechaE, JDateChooser txtFechaS) {
		if (txtFechaS.getDate() != null && txtFechaE.getDate() != null) {
			if (txtFechaS.getDate().after(txtFechaE.getDate())) {
				...
				txtValor.setText("");
				JOptionPane.showMessageDialog(null, "Primero de realizar el Check-In");
			}
		}
	}
